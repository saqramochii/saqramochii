...
# Techstack
[![My Skills](https://skillicons.dev/icons?i=java,notion,windows,blender,robloxstudio,rust,bash,linux,regex,mysql,postman,html,css,git,github,js,ts,ae,ps,postgres,maven,idea,webstorm,vscode,spring)](https://skillicons.dev)
